...
export class SubscriptionMigration1648733638821 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE public."subscription_item" ( "id" TEXT NOT NULL PRIMARY KEY , "subscription_id" TEXT NOT NULL, "period" TEXT NOT NULL, "metadata" jsonb, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE)`);
